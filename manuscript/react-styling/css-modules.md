...
The same caution applies similarly to the last section: some of these styles like `input` and `label` might be more efficient in a global *src/index.css* file without CSS modules.
